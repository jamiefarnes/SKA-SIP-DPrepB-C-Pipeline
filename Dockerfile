...
USER root
RUN mkdir sdp
RUN conda install python=3.5 && conda install -c condo-forge dask distributed && conda install setuptools && conda install numpy && conda install -c conda-forge matplotlib && conda install -c conda-forge casacore && conda install -c conda-forge python-casacore
