...
RUN conda install python=3.5 && conda install dask=0.19.2 distributed=1.23.2 && conda install setuptools && conda install numpy && conda install -c conda-forge matplotlib && conda install -c conda-forge casacore && conda install -c conda-forge python-casacore
